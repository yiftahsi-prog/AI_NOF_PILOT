...
BEGIN
  ...
  (v_survey_id, 'time_saved', 'הערכת חיסכון בזמן שבועי הודות ל-AI', 'single-select', true, 10, '["0–1 שעות", "1–3 שעות", "3–5 שעות", "5–10 שעות", "10+ שעות"]'::jsonb),
  ...
  (v_survey_id, 'risks_encountered', 'האם נתקלת בבעיות או סיכונים בשימוש ב-AI?', 'multi-select', true, 14, '["טעויות מהותיות בתוכן", "קוד שגוי", "חשש לדליפת מידע", "תלות יתר בכלי", "לא נתקלתי בבעיות"]'::jsonb),
  (v_survey_id, 'risk_description', 'אם כן – תיאור קצר (אופציונלי)', 'free-text', false, 15, null),
  (v_survey_id, 'training_needs', 'אילו הכשרות או הנחיות היו משפרות את השימוש שלך ב-AI?', 'multi-select', true, 16, '["קווים מנחים ברורים", "דוגמאות שימוש מאושרות", "הדרכה טכנית", "הדרכת אבטחת מידע", "לא נדרש"]'::jsonb),
  (v_survey_id, 'free_comments', 'הערות חופשיות', 'free-text', false, 17, null),
  (v_survey_id, 'suggested_tool', 'יש מודל או כלי מהאינטרנט שעוזר לך בעבודה והיית רוצה להכניס לארגון? (אופציונלי)', 'free-text', false, 18, null);
END $$;
